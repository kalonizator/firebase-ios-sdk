...
void CountingQueryEngine::SetLocalDocumentsView(
  ...
  local_documents_ = absl::make_unique<LocalDocumentsView>(remote_documents_.get(), mutation_queue_.get(), document_overlay_cache_.get(), local_documents->index_manager());
